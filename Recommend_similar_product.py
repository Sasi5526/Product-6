...
prod_cust_pivot_df = prod_cust_df.pivot(index='user_id',columns='product_category',values='review_score').fillna(0)
...
prod_correlation_df.to_csv('C:\\Users\\sasim\\OneDrive\\Desktop\\product\\Product-Product-Correlation-Matrix.csv')
